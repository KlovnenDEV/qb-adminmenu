local Translations = {
    ...
    menu = {
        ...
        ["print_dev"] = "Print Dev Mode",
        ["coordinate_finder"] = "Coordinate Finder",
        ["xy_printer"] = "XY Printer (for PolyZone)",
        ["object_finder"] = "Object Finder",
        ["of_printer"] = "Outfit Printer",
        ["ne_deleter"] = "Network Entity Deleter",
    ...
    desc = {
        ...
        ["hud_dev_mode_desc"] = "Enable/Disable Hud Developer Mode",
        ["print_dev_mode_desc"] = "Enable/Disable Printing Developer Mode",
