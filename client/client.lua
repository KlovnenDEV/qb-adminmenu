...
local print_dev_button = menu11:AddCheckbox({
    icon = '⚠️',
    label = Lang:t("menu.print_dev"),
    value = nil,
    description = Lang:t("desc.print_dev_mode_desc")
})
...
print_dev_button:On('change', function(_, _, _)
    TriggerEvent('qb-admin:client:TogglePrintDev')
end)
